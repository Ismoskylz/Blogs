...
<html>
    <head>
        ...
        <title>Tasty Foods | Admin Add Recipes Post</title>
      ...
      <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Create Recipes Post</h2>
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <button type="submit" name="add-post" class="btn btn-big">Add Recipes Post</button> 
                    </div>
                </form>
